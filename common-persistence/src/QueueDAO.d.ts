...
export interface QueueDAO {
    ...
    pushIfNotExists(queueName: string, id: string, offsetTimeInSecond: number, priority?: number): Promise<boolean>;
    ...
    setUnackTimeoutIfShorter(queueName: string, messageId: string, unackTimeout: number): Promise<boolean>;
    ...
    postpone(queueName: string, messageId: string, priority: number, postponeDurationInSeconds: number): Promise<boolean>;
...
//# sourceMappingURL=QueueDAO.d.ts.map