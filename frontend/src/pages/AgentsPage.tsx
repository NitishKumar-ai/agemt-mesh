...
export function AgentsPage() {
  ...
  return (
    <div className="page">
            ...
            >
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div>
                    <div style={{ fontWeight: 600, fontSize: 16, letterSpacing: "-0.2px" }}>{agent.name}</div>
                ...
                {agent.capabilities.map((cap) => (
                  <span
                    ...
                    style={{
                      ...
                      fontWeight: 600, background: "var(--surface-card)",
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 18, fontSize: 12, color: "var(--muted)", borderTop: "1px solid var(--hairline)", paddingTop: 12, marginTop: 2 }}>
                <div>
                  <span style={{ fontWeight: 600, textTransform: "uppercase", fontSize: 10, letterSpacing: "0.5px" }}>Model</span>
                  <div style={{ color: "var(--brand-teal)", fontWeight: 600, marginTop: 3 }}>{agent.model}</div>
                </div>
                <div>
                  <span style={{ fontWeight: 600, textTransform: "uppercase", fontSize: 10, letterSpacing: "0.5px" }}>Sandbox</span>
                  <div style={{ fontWeight: 600, marginTop: 3, color: agent.sandbox ? "var(--success)" : "var(--muted-soft)" }}>
                    {agent.sandbox ?? "none"}
                  </div>
                </div>
                <button
                  style={{
                    ...
                    padding: "6px 14px", borderRadius: 12, border: 0,
      ...
      {runTarget && (
        <div style={{
          position: "fixed", inset: 0, background: "rgba(10,10,10,0.3)",
          display: "grid", placeItems: "center", zIndex: 100,
          backdropFilter: "blur(4px)",
        }} onClick={() => setRunTarget(null)}>
          <div
            style={{
              background: "var(--canvas)", borderRadius: 24, padding: 32,
              width: 440, maxWidth: "90vw", border: "1px solid var(--hairline)",
              boxShadow: "0 20px 60px rgba(10,10,10,.12)",
            }}
            onClick={(e) => e.stopPropagation()}
          >
            <h2 style={{ marginBottom: 20, fontSize: 20, fontWeight: 500, letterSpacing: "-0.5px" }}>
              Run {agents.find((a) => a.id === runTarget)?.name ?? runTarget}
            </h2>
            <label style={{ display: "block", fontSize: 12, fontWeight: 600, marginBottom: 6, color: "var(--muted)", textTransform: "uppercase", letterSpacing: "0.5px" }}>
              Goal
            </label>
            <input
              value={goal}
              ...
              style={{
                ...
                border: "1px solid var(--hairline)", fontSize: 14,
                background: "var(--canvas)", marginBottom: 14, color: "var(--ink)",
              }}
            />
            <label style={{ display: "block", fontSize: 12, fontWeight: 600, marginBottom: 6, color: "var(--muted)", textTransform: "uppercase", letterSpacing: "0.5px" }}>
              Context (optional)
            ...
            <textarea
              ...
              style={{
                width: "100%", padding: "10px 14px", borderRadius: 12,
                border: "1px solid var(--hairline)", fontSize: 14,
                background: "var(--canvas)", marginBottom: 20, resize: "vertical",
                color: "var(--ink)",
              }}
            />
