      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-bottom">
          <div className="github-card">
            ...
            <div>
              <strong>{githubStatus?.connected ? githubStatus.account?.name || githubStatus.account?.login : "Connect GitHub"}</strong>
              <span>{githubStatus?.connected ? `@${githubStatus.account?.login}` : "Give agents repository context."}</span>
            </div>
