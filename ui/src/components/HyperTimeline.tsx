...
/**
 * HyperTimeline component – displays a two‑column master‑detail view of ingested
...
export const HyperTimeline: React.FC = () => {
  ...
  return (
    <div className="hyper-timeline running-layout" style={{ display: 'flex', gap: 'var(--sp-md)' }}>
      {/* Document Sidebar */}
      <aside
