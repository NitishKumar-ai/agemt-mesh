...
export class MySQLConcurrentExecutionLimitDAO implements ConcurrentExecutionLimitDAO {
  constructor(private readonly db: Kysely<Database>) {}

  async addTaskToLimit(task: TaskModel): Promise<void> {
    // No-op for MySQL as it uses task_in_progress table directly in exceedsLimit
  }
