...
class LinkedInProvider(SocialProvider):
    ...
    def required_scopes(self) -> list[str]:
        # Member scopes work with "Share on LinkedIn" + OpenID Connect products.
        # Organization scopes require Marketing Developer Platform approval in the
        # LinkedIn Developer Portal — needed to list/connect company pages.
        return [
            "openid",
            "profile",
            "w_member_social",
