---
description: "Task Domains — route AgentMesh tasks to specific worker groups for isolated development, testing, and canary deployments."
---
# Task Domains
...
```
	agentmesh.worker.T2.domain=mydomain //Task T2 needs to poll for domain "mydomain"
```
#### REST call
