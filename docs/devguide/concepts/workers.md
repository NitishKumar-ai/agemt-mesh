...
1. **Poll** — The worker polls the AgentMesh server for tasks of a specific type.
...
Workers can be scaled independently of the AgentMesh server:

- **Horizontal scaling** — Run multiple instances of the same worker. AgentMesh distributes tasks across all polling workers automatically.
